...
const handler: Handler = async (event: HandlerEvent, context: HandlerContext) => {
  ...
  try {
    ...
    const pathParams = parsePathParams(event.path, '/api/users/[id]/following');
    ...
    return responses.internalServerError('Failed to fetch following');
  }
};
