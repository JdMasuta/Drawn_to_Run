...
export const EventCard: React.FC<EventCardProps> = ({ 
  ...
  const isCapacityFull = event.capacity && event.registration_count && event.registration_count >= event.capacity;
          ...
          {event.capacity && (
            <div className="flex items-center text-sm text-gray-500">
              ...
              <span>
                ...
                {isCapacityFull && <span className="text-red-600 font-medium ml-1">(Full)</span>}
              </span>
            </div>
          )}
